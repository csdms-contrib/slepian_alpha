function [K2,K1,K]=klmlmp2rotp(Klmlmp,lonc,latc)
% [K2,K1,K]=KLMLMP2ROTP(Klmlmp,lonc,latc)
% 
% Parallelized version of KLMLMP2ROT
%
% INPUT:
%
...
%
% When a region (e.g. Antarctica) is rotated to a nonpolar position in
% order for standard KERNELC to be able to compute a localization matrix,
% its solutions will need to be rotated back, as in
...
% frame, e.g. to add the localization kernels for Africa and Antarctica.
%
% Last modified by fjsimons-at-alum.mit.edu, 10/20/2010
% Last modified by plattner-at-alumi.ethz.ch, 01/31/2012
...
try
 ...
 error('Type "matlabpool close" and run again or run KLMLMP2ROT instead')
end
